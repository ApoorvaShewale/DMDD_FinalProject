...
CREATE TABLE PROPERTY(P_ID NUMBER(10) PRIMARY KEY,fk_PROPERTY_M_ID NUMBER(10) NOT NULL CONSTRAINT fk_PROPERTY_M_ID references MANAGEMENT_COMPANY(M_ID),fk_O_ID NUMBER(10) NOT NULL CONSTRAINT fk_O_ID references OWNER(O_ID),P_TYPE VARCHAR(20) NOT NULL,P_CITY VARCHAR(30) NOT NULL,
...
AUTOPAYENABLE VARCHAR(1) NOT NULL);


--CREATE SEQUENCE CUSTOMER_CARD_DETAIL1_SEQ START WITH 4 INCREMENT BY 1;
--EXEC add_custcarddetails (674,44,'04-DEC-34','CREDIT','APOORVA',342);
